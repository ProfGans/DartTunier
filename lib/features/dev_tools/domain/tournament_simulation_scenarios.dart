...
const tournamentDevelopmentScenarios = [
  ...
  TournamentSimulationScenario(name: 'Triple-KO mit entscheidendem Finale', playerCount: 7, stages: [SimulationEliminationStageSpec(name: 'Triple-KO', qualifiers: 1, lossLimit: 3, finalEndsTournament: true)]),
  TournamentSimulationScenario(name: 'Kratzer mit 5 Leben und Freilosen', playerCount: 7, stages: [SimulationEliminationStageSpec(name: 'Kratzer', qualifiers: 1, lossLimit: 5)]),
  TournamentSimulationScenario(name: 'Kratzer mit 10 Leben', playerCount: 4, stages: [SimulationEliminationStageSpec(name: 'Kratzer', qualifiers: 1, lossLimit: 10)]),
  TournamentSimulationScenario(
    name: 'Bo4 Gruppen mit Unentschieden und Bo5 KO',
    playerCount: 8,
    stages: [
  ...
  TournamentSimulationScenario(
    name: 'Doppel-KO mit zwei Spielern',
    playerCount: 2,
    stages: [
      SimulationEliminationStageSpec(
        name: 'Finalrunde',
  ...
  TournamentSimulationScenario(
    name: '301-Gruppen und 501-Finale mit Sets',
    playerCount: 8,
    stages: [
      SimulationGroupStageSpec(
        name: 'Gruppen',
        ...
        groupSizes: [4, 4],
        fixedPerGroup: 2,
        gameFormat: TournamentGameFormat(x01Score: 301, bestOfLegs: 3),
      ),
      SimulationEliminationStageSpec(
        name: 'Finale',
        qualifiers: 1,
  ...
  TournamentSimulationScenario(
    name: 'Triple-KO Grenzfall mit 2 Spielern',
    playerCount: 2,
    stages: [
      SimulationEliminationStageSpec(
        name: 'Triple-KO',
  ...
  TournamentSimulationScenario(
    name: 'Triple-KO Grenzfall mit 3 Spielern',
    playerCount: 3,
    stages: [
      SimulationEliminationStageSpec(
        name: 'Triple-KO',
  ...
  TournamentSimulationScenario(
    name: 'Triple-KO Grenzfall mit 5 Spielern',
    playerCount: 5,
    stages: [
      SimulationEliminationStageSpec(
        name: 'Triple-KO',
  ...
  TournamentSimulationScenario(
    name: 'Triple-KO Grenzfall mit 16 Spielern',
    playerCount: 16,
    stages: [
      SimulationEliminationStageSpec(
        name: 'Triple-KO',
  ...
  TournamentSimulationScenario(
    name: '13 Spieler in drei Gruppen mit sechs KO-Qualifikanten',
    playerCount: 13,
    stages: [
      SimulationGroupStageSpec(
        name: 'Gruppenphase',
  ...
  TournamentSimulationScenario(
    name: 'Planer mit einem Qualifikanten je Gruppe',
    playerCount: 8,
    stages: [
      SimulationGroupStageSpec(
        name: 'Gruppenphase',
